...
if __name__ == "__main__":
    ...
    train_dataset=VideoQADataset('train', args.n_query, args.objs)
    val_dataset=VideoQADataset('val', args.n_query, args.objs)
    ...
    eval_mc.accuracy_metric_cvid('./prediction/{}-{}-{:.2f}.json'.format(sign, best_epoch, best_eval_score), "/storage_fast/ycli/data/vqa/causal/anno/test.csv")
