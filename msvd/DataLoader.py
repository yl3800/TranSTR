...
class VideoQADataset(Dataset):
    def __init__(self, split, obj_num=1, sample_list_path="/storage_fast/ycli/data/vqa/msvd/anno",\
         video_feature_path="/storage_fast/jbxiao/workspace/VideoQA/data/msvd" ):
        ...
        ans=load_file('/storage_fast/ycli/data/vqa/msvd/anno/ans_word.json')
        ...
        # 读取video feature
        frame_feat_file = osp.join('/storage_fast/ycli/data/vqa/msvd/feature/blip/model_base_vqa_capfilt_large', '{}.h5'.format(split))
