...
parser.add_argument("-epoch", type=int, action="store", help="epoch for train", default=12)
...
# dataset
parser.add_argument('-dataset', default='msvd-qa',choices=['msrvtt-qa', 'msvd-qa','next-qa'], type=str)
